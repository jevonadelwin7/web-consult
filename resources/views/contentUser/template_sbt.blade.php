...
<head>
    ...
    <style>
     ...
     <script>
        ...
        // };
        function printPDF() {
          // Menggunakan metode print PDF dari browser
          window.print();
        }
      </script>
</head>
<body >
    ...
    <center>
        ...
        <table >
            ...
            <tr>
                <center>
                    <font size="2"><b> <u>SURAT KETERANGAN BEBAS TEMUAN</u> </b></font><br>
                    <font size="1"><b>Nomor: {{$item->nomor_surat}}</b></font><br>
                </center>
            </tr>
        </table>
        <table >
        ...
        <table  width="540">
            <tr> 
                <td width="670">Sampai dengan saat dikeluarkannya surat ini dan menurut dokumentasi yang ada pada Inspektorat Kabupaten Kepulauan Mentawai bahwa yang bersangkutan :</td>
        ...
        <table  width="540">
            <tr> 
                <td width="20">1.</td>
                <td width="520">Tidak dalam proses pemeriksaan Aparat Pengawas Internal Pemerintah Kabupaten Kepulauan Mentawai dan Eksternal.</td>
        
            </tr>
            <tr> 
                <td>2.</td>
                <td width="520">Tidak dalam proses penyelesaian temuan Aparat Pengawas Internal Pemerintah Kabupaten Kepulauan Mentawai dan Eksternal </td>
            </tr>
        </table>
        <br>
        <table  width="540">
            <tr> 
                <td width="670">Demikian surat keterangan ini dibuat untuk dapat digunakan seperlunya.</td>
    ...
    <button onclick="printPDF()" class="print-button">Print PDF</button>
