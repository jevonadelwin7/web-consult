...
<head>
	...
	<title>Layanan Administrasi, Pelaporan & Konsultasi Inspektorat Kabupaten Kepulauan Mentawai</title>
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<h4>{{$user}}</h4>
												<p class="text-muted">mail.com</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">Lihat Profile</a>
											</div>
										</div>
									</li>
									<li>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item {{ request()->is('layanan_administrasi/surat_bebas_temuan_pemeriksaan','layanan_administrasi/surat_keterangan_tidak_pernah_dijatuhi_hukuman_disiplin')? 'active':''}}">
							...
							<div class="collapse" id="rules">
								<ul class="nav nav-collapse">
									<li>
										<a href="/layanan_administrasi/surat_bebas_temuan_pemeriksaan">
											<span class="sub-item">Surat Bebas Temuan Pemeriksaan</span>
										</a>
									</li>
									<li>
										<a href="/layanan_administrasi/surat_keterangan_tidak_pernah_dijatuhi_hukuman_disiplin">
						...
						<li class="nav-item {{ request()->is('konsultasi_pengaduan/konsultasi_online','konsultasi_pengaduan/pengaduan')? 'active':''}}">
							...
							<div class="collapse" id="adm">
								<ul class="nav nav-collapse">
									<li>
										<a href="/konsultasi_pengaduan/konsultasi_online">
											<span class="sub-item">Konsultasi Online</span>
										</a>
									</li>
									<li>
