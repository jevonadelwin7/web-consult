            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" action="{{route('addConsult')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-inline">
                                        <label for="inlineinput" class="col-md-3 col-form-label">NIP</label>
                                        <div class="col-md-9 p-0">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>SK Bebas Penguasaan Asset</td>
                                        <td>
                                        ...
                                        <td> @if($item->sk_bebas_asset == NULL)
                                            <a>Data Belum Diupload</a>
                                            @else
                                            <a type="button" class="btn btn-xs btn-primary" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_asset)}}" target="_blank">Lihat</a>                        
                                            @endif
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td >SK Bebas Utang </td>
                                        <td> @if($item->sk_bebas_utang == NULL)
                                            <p><i class="fas fa-window-close fa-2x" style="color:red"></i></p>
                                            @else
                                            <p><i class="fas fa-check-square fa-2x" style="color:green"></i></p>                     
                                            @endif</td>
                                        <td>
                                            ...
                                            <a>Data Belum Diupload</a>
                                            @else
                                            <a type="button" class="btn btn-xs btn-primary" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_utang)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>SK Bebas Ikatan Dinas</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a>Data Belum Diupload</a>
                                            @else
                                            <a type="button" class="btn btn-xs btn-primary" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_ikatan_dinas)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td> SK Bebas Hukuman Disiplin</td>
                                        <td>
                            ...
                            <form method="post" action="{{route('updateMessageSBT', $item->id)}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title" id="exampleModalLabel">Permohonan Surat Bebas Temuan</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control" id="defaultInput" name="tipe" value="sbt" hidden>
                                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('updateSbt', $item->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
