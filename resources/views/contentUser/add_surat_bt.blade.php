        ...
        <div class="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">E-Form Permohonan Bebas Temuan</div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="post" action="{{route('store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            @if($item->sk_pangkat == NULL)
                                            @else
                                            <a type="button" class="btn btn-xs btn-success" href="{{url('adminfrontend/sbt_file/',$item->sk_pangkat)}}" target="_blank">Lihat</a>                       
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group input-group">
                                        <label for="inlineinput" class="col-md-3 col-form-label mr-5"> SK Bebas Penguasaan Asset </label>
                                        <div class="custom-file mr-2">
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="sk_bebas_asset">
                                            @if($item->sk_bebas_asset == NULL)
                                            
                                            @else
                                            <span>{{$item->sk_bebas_asset}}</span>                       
                                            @endif
                                        </div>
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-xs btn-primary mr-1">Simpan</button>
                                            @if($item->sk_bebas_asset == NULL)
                                            @else
                                            <a type="button" class="btn btn-xs btn-success" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_asset)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group input-group">
                                        <label for="inlineinput" class="col-md-3 col-form-label mr-5"> SK Bebas Utang </label>
                                        <div class="custom-file mr-2">
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="sk_bebas_utang">
                                            @if($item->sk_bebas_utang == NULL)
                                            
                                            @else
                                            <span>{{$item->sk_bebas_utang}}</span>                       
                                            @endif
                                        </div>
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-xs btn-primary mr-1">Simpan</button>
                                            @if($item->sk_bebas_utang == NULL)
                                            @else
                                            <a type="button" class="btn btn-xs btn-success" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_utang)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group input-group">
                                        <label for="inlineinput" class="col-md-3 col-form-label mr-5"> SK Bebas Ikatan Dinas </label>
                                        <div class="custom-file  mr-2">
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="sk_bebas_ikatan_dinas">
                                            @if($item->sk_bebas_ikatan_dinas == NULL)
                                            
                                            @else
                                            <span>{{$item->sk_bebas_ikatan_dinas}}</span>                       
                                            @endif
                                        </div>
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-xs btn-primary mr-1">Simpan</button>
                                            ...
                                            @else
                                            <a type="button" class="btn btn-xs btn-success" href="{{url('adminfrontend/sbt_file/',$item->sk_bebas_ikatan_dinas)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </div>
                                    </div>

                                    <div class="form-group input-group">
                                        <label for="inlineinput" class="col-md-3 col-form-label mr-5"> SK Bebas Hukuman Disiplin </label>
                                        <div class="custom-file mr-2">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            @if($item->sp_hukuman_disiplin == NULL)
                                            @else
                                            <a type="button" class="btn btn-xs btn-success" href="{{url('adminfrontend/sbt_file/',$item->sp_hukuman_disiplin)}}" target="_blank">Lihat</a>                        
                                            @endif
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="card-action">
                                    @if(is_null($item->sp_hukuman_disiplin) || is_null($item->sk_pangkat) ||is_null($item->sk_bebas_asset) || is_null($item->sk_bebas_ikatan_dinas) || is_null($item->sk_bebas_utang) )
                                    ...
                                    @else
                                    <form method="post" action="/is_upload/{{$item->id_permohonan}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <input type="text" value="{{$item->id_permohonan}}" name="id_permohonan" hidden>
                                        </div>
