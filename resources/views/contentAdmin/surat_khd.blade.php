                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg " data-original-title="Lihat Berkas" href="{{url('/surat_keterangan_tidak_pernah_dijatuhi_hukuman_disiplin/permohonan_baru',$item->id)}}" >
